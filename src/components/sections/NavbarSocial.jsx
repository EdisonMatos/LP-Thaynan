...
export default function NavbarSocial({ colorMode }) {
  ...
  const getNavbarClasses = () => {
    ...
    // default
    return scrolling
      ? "bg-gradient-to-b from-darker to-darker bg-opacity-100 shadow-lg border-b-[1px] border-primary"
      : "bg-gradient-to-b from-darker to-transparent border-b-[1px] border-none";
  };
    ...
    <div className="w-full">
      ...
      >
        <Navbar>
          <ScrollLink
            to="home"
            className="cursor-pointer w-[60%] phone2:w-[65%] phone3:w-[70%] tablet1:w-[40%] tablet2:w-[40%] desktop1:w-[50%] desktop2:w-[800px]"
            spy={true}
            smooth={true}
            duration={500}
            offset={-100}
          ...
          >
            <img
              ...
              className={`bg-transparent ${
                scrolling
                  ? "w-[90%] tablet1:w-[80%] tablet2:w-[70%] desktop1:w-[50%]"
                  : "my-[20px] w-full"
